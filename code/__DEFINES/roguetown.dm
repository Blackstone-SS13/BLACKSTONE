...
#define ALL_RACES_LIST		list("humen", "dwarf", "elf", "tiefling", "argonian", "aasimar")

#define ALL_RACES_LIST_NAMES		list("Humen", "Half-Elf", "Elf", "Elf", "Dwarf","Dwarf","Tiefling", "Aasimar")

...
/datum/preferences/proc/SetChoices(mob/user, limit = 14, list/splitJobs = list("Captain of the Guard", "Priest", "Merchant", "Butler", "Bog Elder", "Goblin King"), widthPerColumn = 295, height = 620) //295 620
	if(!SSjob)
		return

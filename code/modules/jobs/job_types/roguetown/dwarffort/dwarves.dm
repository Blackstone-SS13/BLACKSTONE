...
/datum/outfit/job/roguetown/provisioner/proc/assign_skills(mob/living/carbon/human/provisioner)
	...
	provisioner.mind.adjust_skillrank(/datum/skill/craft/cooking, 3, TRUE)
	provisioner.mind.adjust_skillrank(/datum/skill/craft/crafting, 5, TRUE)
	provisioner.mind.adjust_skillrank(/datum/skill/craft/tanning, 5, TRUE)
	provisioner.mind.adjust_skillrank(/datum/skill/misc/sewing, 5, TRUE)
	provisioner.mind.adjust_skillrank(/datum/skill/misc/medicine, 3, TRUE)

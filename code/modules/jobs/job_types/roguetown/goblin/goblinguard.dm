...
/datum/job/roguetown/goblinguard/get_outfit(mob/living/carbon/human/wearer, visualsOnly = FALSE, announce = TRUE, latejoin = FALSE, preference_source = null)
...
/datum/outfit/job/roguetown/goblinguard/proc/assign_skills(mob/living/carbon/human/guard)
...
/datum/outfit/job/roguetown/goblinguard/bowman
	name = "Town Bowman Guard"
	is_bowman = TRUE

/datum/outfit/job/roguetown/goblinguard/bowman/assign_skills(mob/living/carbon/human/guard)

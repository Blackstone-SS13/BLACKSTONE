/datum/job/roguetown/lunatic
	...
	bypass_jobban = FALSE
	min_pq = null //This role is meant to be locked to only those with -15 PQ, then be unrollable once they hit -14 so they can roll Prisoner, don't fuck with this.
	max_pq = -15

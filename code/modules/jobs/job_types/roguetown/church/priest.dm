...
/datum/outfit/job/roguetown/priest/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		...
		H.mind.adjust_skillrank(/datum/skill/combat/unarmed, pick(0,0,1), TRUE)
		H.mind.adjust_skillrank(/datum/skill/misc/athletics, pick(0,0,1), TRUE)
		H.mind.adjust_skillrank(/datum/skill/misc/reading, pick(4,5,5,6), TRUE)
		...
		H.mind.adjust_skillrank(/datum/skill/misc/riding, pick(1,2,2,2,2), TRUE)
		...
		if(H.age == AGE_OLD)
			H.mind.adjust_skillrank(/datum/skill/magic/holy, pick(4,5,5,5,5,6), TRUE)
			H.mind.adjust_skillrank(/datum/skill/combat/polearms, pick(1,2,2,2), TRUE)
			H.mind.adjust_skillrank(/datum/skill/combat/axesmaces, pick(1,2,2,2), TRUE)
			H.change_stat("intelligence", pick(2,2,3))
			H.change_stat("perception", pick(1,1,2))
			H.change_stat("speed", pick(-2,-2,-2,-1))
		else
			H.mind.adjust_skillrank(/datum/skill/magic/holy, pick(3,4,4,5), TRUE)
			...
			H.change_stat("perception", pick(0,0,0,1))
			H.change_stat("strength", pick(0,0,0,1))
			H.change_stat("constitution", pick(-1,-1,-1,0))
			H.change_stat("endurance", pick(0,0,1))
			H.change_stat("speed", pick(-2,-1,-1,0))

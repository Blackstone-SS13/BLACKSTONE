...
/datum/outfit/job/roguetown/templar/pre_equip(mob/living/carbon/human/H)
	...
	switch(H.patron.name)
		if("Astrata")
			...
			cloak = /obj/item/clothing/cloak/tabard/crusaderastrata
		if("Dendor")
			neck = /obj/item/clothing/neck/roguetown/psicross/dendor
			head = /obj/item/clothing/head/roguetown/helmet/heavy/dendorhelm
			cloak = /obj/item/clothing/cloak/tabard/crusaderdendor
		if("Necra")
			neck = /obj/item/clothing/neck/roguetown/psicross/necra
			head = /obj/item/clothing/head/roguetown/helmet/heavy/necrahelm
			cloak = /obj/item/clothing/cloak/tabard/crusadernecra
		if("Pestra")
			neck = /obj/item/clothing/neck/roguetown/psicross/pestra
			cloak = /obj/item/clothing/cloak/tabard/crusaderpestra
		if("Noc")
			neck = /obj/item/clothing/neck/roguetown/psicross/noc
			head = /obj/item/clothing/head/roguetown/helmet/heavy/nochelm
			cloak = /obj/item/clothing/cloak/tabard/crusadernoc

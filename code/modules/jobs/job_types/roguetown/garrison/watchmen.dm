...
/datum/outfit/job/roguetown/watchmen/proc/assign_skills(mob/living/carbon/human/watchmen)
	...
	guard.mind.adjust_skillrank(/datum/skill/combat/bows, pick(3,3,4), TRUE)
	guard.mind.adjust_skillrank(/datum/skill/combat/crossbows, (2,2,3), TRUE)
	guard.mind.adjust_skillrank(/datum/skill/combat/wrestling, (3,3,4), TRUE)
	guard.mind.adjust_skillrank(/datum/skill/combat/unarmed, (3,3,4), TRUE) 
	guard.mind.adjust_skillrank(/datum/skill/combat/swords, 3, TRUE)
	guard.mind.adjust_skillrank(/datum/skill/combat/polearms, pick(1,2), TRUE)
	guard.mind.adjust_skillrank(/datum/skill/combat/whipsflails, pick(1,2), TRUE)

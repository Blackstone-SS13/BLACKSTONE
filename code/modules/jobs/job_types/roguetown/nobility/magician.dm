...
/datum/outfit/job/roguetown/magician/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		...
		H.mind.adjust_skillrank(/datum/skill/misc/athletics, pick(0,1,1), TRUE)
		...
		H.mind.adjust_skillrank(/datum/skill/misc/reading, pick(3,3,4), TRUE)
		H.mind.adjust_skillrank(/datum/skill/craft/crafting, pick(1,1,2), TRUE)
		H.mind.adjust_skillrank(/datum/skill/misc/medicine, pick(2,2,3), TRUE)
		H.mind.adjust_skillrank(/datum/skill/craft/cooking, pick(0,0,1), TRUE)
		H.mind.adjust_skillrank(/datum/skill/misc/reading, 6, TRUE)
		H.mind.adjust_skillrank(/datum/skill/magic/arcane, pick(5,5,6), TRUE)

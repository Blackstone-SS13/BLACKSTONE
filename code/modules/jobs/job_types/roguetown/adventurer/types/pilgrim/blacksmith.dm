...
/datum/outfit/job/roguetown/adventurer/blacksmith/pre_equip(mob/living/carbon/human/H)
	...
	if(H.gender == MALE)
		...
		if(H.mind)
			H.mind.adjust_skillrank(/datum/skill/combat/swords, pick(1,2,2), TRUE) // If you can make a sword you can swing one.
			...
			H.mind.adjust_skillrank(/datum/skill/misc/athletics, pick(1,2,2), TRUE) 

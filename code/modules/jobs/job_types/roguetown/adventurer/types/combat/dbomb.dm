...
/datum/outfit/job/roguetown/adventurer/dbomb/pre_equip(mob/living/carbon/human/H)
	...
	H.mind.adjust_skillrank(/datum/skill/craft/carpentry, rand(3,3,4), TRUE)
	H.mind.adjust_skillrank(/datum/skill/craft/masonry, rand(3,3,4), TRUE)
	H.mind.adjust_skillrank(/datum/skill/craft/engineering, rand(2,2,4,4,5), TRUE)

...
/datum/outfit/job/roguetown/adventurer/sfighter/pre_equip(mob/living/carbon/human/H)
	...
	switch(classchoice)
		...
		if("Warrior")
			...
			H.mind.adjust_skillrank(/datum/skill/combat/polearms, pick(2,2,3,3,4), TRUE)
			H.mind.adjust_skillrank(/datum/skill/combat/axesmaces, pick(2,2,3,3,4), TRUE)
			H.mind.adjust_skillrank(/datum/skill/combat/bows, rand(1,2), TRUE)
			H.mind.adjust_skillrank(/datum/skill/combat/wrestling, 2, TRUE)
			H.mind.adjust_skillrank(/datum/skill/combat/unarmed, 2, TRUE)
			H.mind.adjust_skillrank(/datum/skill/misc/athletics, 4, TRUE)
			H.mind.adjust_skillrank(/datum/skill/combat/swords, pick(2,2,3,3,4), TRUE)
		...
		if("Monster Hunter")
			...
			H.mind.adjust_skillrank(/datum/skill/combat/crossbows, rand(1,2,2), TRUE)
			H.mind.adjust_skillrank(/datum/skill/combat/bows, rand(1,2,2), TRUE)
			H.mind.adjust_skillrank(/datum/skill/combat/wrestling, 2, TRUE)
			H.mind.adjust_skillrank(/datum/skill/combat/unarmed, 2, TRUE)
			H.mind.adjust_skillrank(/datum/skill/misc/athletics, 4, TRUE)
			H.mind.adjust_skillrank(/datum/skill/combat/knives, rand(1,3), TRUE)

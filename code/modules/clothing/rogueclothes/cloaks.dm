...
//	allowed_sex = list("male")
	allowed_race = list("hume n", "tiefling", "argonian", "elf", "aasimar")
	detail_tag = "_det"
	detail_color = CLOTHING_PURPLE
...
/obj/item/clothing/cloak/cape/puritan
	...
	allowed_race = list("hume n", "tiefling", "argonian", "elf", "dwarf", "aasimar")

/obj/item/clothing/cloak/cape/archivist
	icon_state = "puritan_cape"
	color = CLOTHING_BLACK
	allowed_race = list("hume n", "tiefling", "argonian", "argonian", "elf", "dwarf", "aasimar")
...
/obj/item/clothing/cloak/chasuble
	...
	slot_flags = ITEM_SLOT_CLOAK
	allowed_sex = list(MALE)
	allowed_race = list("hume n", "tiefling", "argonian", "aasimar")
	nodismemsleeves = TRUE

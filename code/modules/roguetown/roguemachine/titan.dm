...
/proc/make_law(raw_message)
	...
	priority_announce("[length(GLOB.laws_of_the_land)]. [raw_message]", "A LAW IS DECLARED", pick('new_law.ogg', 'new_law2.ogg'), "Captain")
...
/proc/remove_law(law_index)
	...
	priority_announce("[law_index]. [law_text]", "A LAW IS ABOLISHED", pick('new_law.ogg', 'new_law2.ogg'), "Captain")

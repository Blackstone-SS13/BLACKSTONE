...
/datum/sprite_accessory/hair/bald
	name = "Bald"
	icon_state = ""
	specuse = list("humen", "dwarf", "elf", "aasimar")
	gender = MALE

/datum/sprite_accessory/hair/skinhead
	name = "Shaved"
	icon_state = "hair_skinhead"
	specuse = list("humen", "dwarf", "elf")
	gender = MALE
	under_layer = TRUE
...
/datum/sprite_accessory/hair/bowlcut
	...
	gender = MALE
	specuse = list("hume n", "tiefling", "aasimar")
...
/datum/sprite_accessory/hair/father
	...
	gender = MALE
	specuse = list("dwarf","humen", "aasimar")
	under_layer = TRUE
...
/datum/sprite_accessory/hair/merc
	...
	gender = MALE
	specuse = list("dwarf", "hume n", "tiefling", "aasimar")
...
/datum/sprite_accessory/hair/ftwin
	...
	gender = FEMALE
	specuse = list("dwarf", "hume n", "tiefling")
...
/datum/sprite_accessory/hair/ftomboy
	...
	icon_state = "hair_runt"
	gender = FEMALE
	specuse = list("humen", "dwarf", "aasimar")
...
/datum/sprite_accessory/facial_hair/shaved
	...
	gender = MALE
	specuse = list("humen", "elf", "aasimar")
...
/datum/sprite_accessory/facial_hair/pipe
	...
	gender = MALE
	specuse = list("humen", "elf", "tiefling")

/datum/sprite_accessory/facial_hair/hermit
	name = "Wise Hermit"
	icon_state = "facial_moonshiner"
	gender = MALE
	specuse = list("humen", "elf")

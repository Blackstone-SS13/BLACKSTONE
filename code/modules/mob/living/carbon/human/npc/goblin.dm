...
/datum/species/goblin
	...
	inherent_traits = list(RTRAIT_NOROGSTAM,TRAIT_RESISTCOLD,TRAIT_RESISTHIGHPRESSURE,TRAIT_RESISTLOWPRESSURE,TRAIT_RADIMMUNE)
...
/mob/living/carbon/human/species/goblin/after_creation()
	...
	ADD_TRAIT(src, RTRAIT_NOROGSTAM, TRAIT_GENERIC)

	...
	if(summoner)
		if(get_dist(get_turf(summoner),get_turf(src)) <= range)
			...
			if(istype(summoner.loc, /obj/effect))
				...
				to_chat(summoner, span_holoparasite("I moved out of range, and were pulled back! You can only move [range] meters from <font color=\"[namedatum.colour]\"><b>[real_name]</b></font>!"))

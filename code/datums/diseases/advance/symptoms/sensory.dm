		...
		if(4, 5)
			...
			if(HAS_TRAIT_FROM(M, TRAIT_BLIND, EYE_DAMAGE))
				if(prob(20))
					...
					to_chat(M, span_notice("I can finally focus my eyes on distant objects."))
					M.cure_nearsighted(EYE_DAMAGE)
					M.blur_eyes(10)
			...
			if(prob(base_message_chance))
				to_chat(M, span_notice("[pick("Your eyes feel great.","You feel like my eyes can focus more clearly.", "You don't feel the need to blink.","Your ears feel great.","Your healing feels more acute.")]"))

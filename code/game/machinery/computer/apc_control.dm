...
/obj/machinery/computer/apc_control/emag_act(mob/user)
	if(!authenticated)
		to_chat(user, span_warning("I bypass [src]'s access requirements using your emag."))
		authenticated = TRUE
		log_activity("logged in")
	else if(!(obj_flags & EMAGGED))
		user.visible_message(span_warning("I emag [src], disabling precise logging and allowing you to clear logs."))

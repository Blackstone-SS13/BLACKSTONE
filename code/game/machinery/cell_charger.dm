...
/obj/machinery/cell_charger/attackby(obj/item/W, mob/user, params)
	if(istype(W, /obj/item/stock_parts/cell) && !panel_open)
		...
		if(charging)
			...
			charging = W
			user.visible_message(span_notice("[user] inserts a cell into [src]."), span_notice("I insert a cell into [src]."))
			update_icon()
	else
...
/obj/machinery/cell_charger/attack_hand(mob/user)
	...
	user.visible_message(span_notice("[user] removes [charging] from [src]."), span_notice("I remove [charging] from [src]."))

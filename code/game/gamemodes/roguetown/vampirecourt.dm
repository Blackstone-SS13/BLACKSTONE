// antag list MINUS vampire lord antag
var/global/list/roguegamemodes = list("Rebellion", "Extended", "Aspirants", "Bandits", "Maniac", "CANCEL")

/datum/game_mode/vampirecourt
	name = "vampirecourt"
	config_tag = "vampirecourt"
	report_type = "vampirecourt"
...
// MAJOR ANTAGS
	...
	var/list/datum/mind/inquisitors = list()
...
/datum/game_mode/chaosmode/proc/pick_werewolves()
	restricted_jobs = list("Acolyte", "Templar", "Priest","Adventurer","Confessor","Town Guard","Veteran","Castle Guard","Sheriff","Knight","Bog Guard","Bog Master","Inquisitor")

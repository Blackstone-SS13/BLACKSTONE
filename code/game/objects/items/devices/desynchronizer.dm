...
/obj/item/desynchronizer/proc/desync(mob/living/user)
	...
	to_chat(user, span_notice("I activate [src], desynchronizing myself from the present. You can still see your surroundings, but you feel eerily dissociated from reality."))

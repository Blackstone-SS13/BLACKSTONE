...
/obj/item/throw_impact(atom/hit_atom, datum/thrownthing/throwingdatum)
	if(hit_atom && !QDELETED(hit_atom))
		...
		return hit_atom.hitby(src, 0, itempush, throwingdatum=throwingdatum, melee_type=melee_type)
...
/obj/item/hitby(atom/movable/AM, skipcatch, hitpush, blocked, datum/thrownthing/throwingdatum, melee_type)
	return

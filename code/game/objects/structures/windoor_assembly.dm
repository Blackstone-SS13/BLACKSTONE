	...
	switch(state)
		if("01")
			...
			//Adding cable to the assembly. Step 5 complete.
				...
				user.visible_message(span_notice("[user] wires the windoor assembly."), span_notice("I start to wire the windoor assembly..."))
		...
		if("02")
			...
			if(W.tool_behaviour == TOOL_WIRECUTTER)
				user.visible_message(span_notice("[user] cuts the wires from the airlock assembly."), span_notice("I start to cut the wires from airlock assembly..."))
